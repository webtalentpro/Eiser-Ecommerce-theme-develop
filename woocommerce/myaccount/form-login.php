...
<section class="customer_login_register_form">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <form class="woocommerce-form woocommerce-form-login login" method="post">
                    ...
                    <p
                        ...
                        <label for="username"><?php esc_html_e('Username or email address', 'woocommerce'); ?>&nbsp;<span class="required">*</span>
                        </label>
                        <input
                            type="text"
                    ...
                    <p class="form-row">
                        ...
                        <button
                            ...
                            name="login"
                            value="<?php esc_attr_e('Login', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
                    </p>
            ...
            <div class="col-md-7">
                ...
                <?php else : ?>
                    ...
                    <p><?php esc_html_e('A link to set a new password will be sent to your email
                        address.', 'woocommerce'); ?></p>
